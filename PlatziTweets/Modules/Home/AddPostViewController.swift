...
//  PlatziTweets
//
//  Created by Jose Octavio on 16/08/20.
...
//        Validamos que el usuario tenga el gps activo y disponibe
    ...
    private func uploadPhotoToFirebase() {
        ...
        //        5. poner nombre a la imagen a subir
        let imageName = Int.random(in: 100...1000)
        //        6. crear referencia a la carpeta donde se va a guardar la foto
    ...
    private func uploadVideoToFirebase() {
        ...
        //        3.Configuracion para guardar foto en firebase
        let metaDataConfig = StorageMetadata()
        metaDataConfig.contentType = "vide/MP4"
...
extension AddPostViewController: UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    func imagePickerController(_ picker: UIImagePickerController,
        ...
        if info.keys.contains(.originalImage) {
            ...
            //            De esta forma obtenemos a imagen comentada
